...
app = Flask(
    __name__,
    static_folder=r"C:\Users\Administrator\Documents\chatbot\app\frontend\static",
    template_folder=r'C:\Users\Administrator\Documents\chatbot\app\frontend\templates',
)
...
def stream_inference_generator(user_prompt):
    ...
    try:
        ...
        for chunk in llm_model(prompt=user_prompt, max_tokens=512, temperature=0.7, top_p=0.9, stream=True):
...
def stream_chat():
    ...
    def generate_response():
        ...
        if prompt_template_str and context:
            ...
            logger.info("Using RAG-based prompt.")
